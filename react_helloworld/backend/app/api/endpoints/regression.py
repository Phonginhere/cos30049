...
from react_helloworld.backend.app.models.regression_model import predict
from react_helloworld.backend.app.schemas.request import RegressionInput, RegressionOutput
